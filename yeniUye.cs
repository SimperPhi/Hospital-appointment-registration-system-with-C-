    ...
    public partial class yeniUye : Form
    {
        ...
        void uyeEkle()
        {
            ...
            try
            {
                ...
                {
                    OleDbCommand cmd = new OleDbCommand("insert into Uyeler(TC,Adı,Soyadı,Cinsiyeti,DogumYeri,DogumTarihi,BabaAdı,AnneAdı,CepTel,SabitTel,Eposta,Parola) values ('" + maskedtxtTC.Text.ToString() + "','" + txtAd.Text + "','" + txtSoyad.Text + "','" + cinsiyet + "','" + txtDogumYeri.Text + "','" + maskedtxtDogumTarihi.Text.ToString() + "','" + txtBabaAdı.Text + "','" + txtAnneAdı.Text + "','" + maskedtxtCepTel.Text.ToString() + "','" + maskedtxtSabitTel.Text.ToString() + "','" + "','" + txtParola.Text + "')", frm1.uyelerBaglantisi);
                    cmd.ExecuteNonQuery();
