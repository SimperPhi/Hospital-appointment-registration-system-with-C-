    ...
    public partial class uyeGuncelle : Form
    {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            foreach (Control kontroller in this.Controls)
            {
                ...
                {
                    if (kontroller.Text.Trim() == "" || maskedtxtTC.Text.Length != 11 || maskedtxtDogumTarihi.Text.Length != 10  || maskedtxtCepTel.Text.Length != 14)
                    {
                        hata_Varmi = true;
                        break;
                    }
