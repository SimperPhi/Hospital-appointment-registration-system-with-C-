...
namespace HastaneKayit
{
    public partial class AdminPaneli : Form
    {
        ...
        private void btnDoktorEkle_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Doktoru Ekleyeceğiniz Kliniği Seçmediniz");
            }
        }
        ...
        private void txtDoktorParola_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtDoktorKullaniciAdi_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtDoktorEkle_TextChanged(object sender, EventArgs e)
        {
